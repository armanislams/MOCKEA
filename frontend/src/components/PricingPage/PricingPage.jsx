...
const FAQS = [
  ...
  {
    q: "Are the questions up to date with the latest IELTS format?",
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen py-16 px-4 sm:px-6 lg:px-8 font-sans overflow-hidden">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-blue-200/30 rounded-full filter blur-3xl -z-10" />
        <div className="absolute top-60 -right-40 w-96 h-96 bg-red-200/20 rounded-full filter blur-3xl -z-10" />
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200">
                    ...
                    <th className="p-6 text-sm font-bold text-slate-800 text-center bg-blue-50/50">Elite Success</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  {COMPARISON_FEATURES.map((feature, fIdx) => (
                    <tr key={fIdx} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="p-6 text-center text-sm text-[#000f38] font-black bg-blue-50/20">{feature.elite}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 px-8 py-10 md:px-12 md:py-12 shadow-md max-w-5xl mx-auto mb-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-center items-center">
          <div className="flex flex-col items-center gap-3">
            <div className="p-4 bg-red-50 text-cta-btn rounded-2xl">

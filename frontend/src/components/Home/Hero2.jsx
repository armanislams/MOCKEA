...
const Hero2 = () => {
  return (
    <div className="relative min-h-[60vh] lg:h-[80vh] flex items-center bg-white overflow-hidden font-sans text-gray-900 py-20 lg:py-0">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start space-y-8">
          <motion.div 
            ...
            className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-gray-100 border border-gray-200"
          >
          ...
          <motion.h1 
            ...
            className="text-4xl lg:text-6xl font-extrabold leading-tight tracking-tight text-gray-900"
          >
          ...
          >
            <Link to={'/dashboard'} className="group relative px-8 py-4 bg-gray-900 text-white font-bold rounded-xl overflow-hidden transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
        ...
        <div className="w-full lg:w-1/2 relative h-[350px] lg:h-[450px] flex items-center justify-center mt-10 lg:mt-0">
          ...
          <motion.div
            ...
            className="absolute z-20 w-[65%] h-[75%] rounded-3xl overflow-hidden border border-gray-200 shadow-md"
          >
          ...
          <motion.div
            ...
            className="absolute z-30 top-[2%] right-[0%] w-[45%] h-[40%] rounded-2xl overflow-hidden border border-gray-200 shadow-md"
          >
          ...
          <motion.div
            ...
            className="absolute z-10 bottom-[5%] left-[0%] w-[50%] h-[45%] rounded-2xl overflow-hidden border border-gray-200 shadow-md"
          >
            ...
            <div className="absolute inset-0 bg-linear-to-t from-black/80 via-black/20 to-transparent flex items-end p-4">
               <div>
                  <p className="text-xs text-gray-300 font-semibold mb-1">Study Groups</p>

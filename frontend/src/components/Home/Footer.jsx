const Footer =()=>{
    return (
      <footer className="bg-bc-navy text-white mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 border-b border-blue-800 pb-8">
            <div>
              <h4 className="font-bold text-lg mb-4">MOCKEA</h4>
              <p className="text-blue-200 text-sm leading-relaxed">
                A modern platform to practice and evaluate your listening
                comprehension skills for academic purposes.
              </p>
            </div>
            <div>
          ...
          <div className="text-center text-sm text-blue-300 flex flex-col md:flex-row justify-between items-center">
            <p>
              © {new Date().getFullYear()} MOCKEA. Not affiliated with any

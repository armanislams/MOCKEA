            ...
            <div className="sticky top-24">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-semibold bg-blue-50 text-primary px-2 py-1 rounded">Part 1</span>
                  </div>
                  ...
                  <div className="mt-2 p-4 bg-gray-50 rounded-lg border border-gray-100">
                    <p className="text-sm text-gray-600 leading-relaxed">
                      <span className="font-semibold">Instructions:</span> You will hear a conversation. While listening, use the text area to type exactly what you hear. You can play and pause as needed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hidden lg:block">
                <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2">
                  <span className="w-6 h-6 rounded bg-primary text-white flex items-center justify-center text-sm">i</span>
                  Test Rules
                </h3>
                <ul className="space-y-4 text-sm text-gray-600">
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 rounded-full bg-primary mt-1.5 shrink-0"></span>
                    <span><strong>No repeats:</strong> In the real exam, the audio plays only once. For practice, controls are provided.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 rounded-full bg-primary mt-1.5 shrink-0"></span>
                    <span><strong>Spelling matters:</strong> Incorrect spelling will result in a marked down score.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 rounded-full bg-primary mt-1.5 shrink-0"></span>
                    <span><strong>Word limits:</strong> Pay attention to instructions like "Write NO MORE THAN TWO WORDS".</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col h-full">
              ...
              <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50 rounded-t-xl">
                ...
                <div className="flex items-center gap-4 text-xs font-medium">
                  {transcription.trim() !== '' && (
                    <span className={`transition-opacity duration-300 ${isSaving ? 'text-blue-500' : 'text-green-600'}`}>
                      {isSaving ? 'Saving...' : lastSaved ? `Auto-saved at ${lastSaved.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}` : ''}
                    </span>
                  )}
              ...
              <div className="p-4 border-t border-gray-100 flex justify-end rounded-b-xl bg-gray-50/50">
                ...
                >
                  {isSubmitting ? <span className="loading loading-spinner loading-sm"></span> : 'Submit Answer'}
                </button>
              </div>

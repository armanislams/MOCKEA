...
const SECTIONS = [
  {
    ...
    description:
      "You will hear a conversation between two friends catching up. Listen carefully and answer the questions below.",
    instructions:
    ...
    questions: [
      ...
      },
      {
        ...
        number: 2,
        type: "fill",
        question: "How long has it been since the speakers last met?",
      ...
      },
      {
        ...
        number: 3,
        type: "fill",
        question: "What is the female speaker's new job title?",
      ...
      },
      {
        ...
        number: 4,
        type: "mcq",
        question: "What does the male speaker plan to do next year?",
        options: [
          "A) Travel abroad",
          "B) Start a business",
      ...
      },
      {
        ...
        number: 5,
        type: "fill",
        question: "What hobby did the female speaker recently start?",
      ...
      },
      {
        ...
        number: 6,
        type: "mcq",
        question: "How does the male speaker feel about his current job?",
        options: [
          "A) Very satisfied",
          "B) Somewhat bored",
          "C) Extremely stressed",
          "D) Indifferent",
        ],
      ...
      },
      {
        ...
        number: 7,
        type: "fill",
        question: "What event are they planning to attend together?",
        correctAnswer: "music festival",
      },
      {
        id: "q8",
        number: 8,
      ...
      },
      {
        ...
        number: 9,
        type: "mcq",
        question: "Who else will join them at the event?",
        options: [
          "A) Their colleague Mark",
          "B) The female speaker's sister",
          "C) A group of old school friends",
          "D) Nobody else",
        ],
        ...
        return (
          <a
            ...
            className={`w-9 h-9 rounded-lg flex items-center justify-center text-sm font-bold transition-all duration-200
              ${
                submitted && result
                  ? result.evaluated.find((e) => e.questionId === q.id)
                      ?.isCorrect
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <div className="flex items-center gap-3 bg-white px-5 py-3 rounded-xl shadow-sm border border-gray-200 self-start md:self-auto">
            ...
            <div>
              ...
              <p className="text-2xl font-mono font-extrabold text-primary tracking-tight">
                {fmt(elapsed)}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-md border border-gray-200/80 p-5 sm:p-6 mb-8">
          ...
          <div className="mt-4 p-4 bg-amber-50 border border-amber-200/60 rounded-xl">
            <p className="text-sm text-amber-900">
              <span className="font-bold">⚠ Test Conditions:</span> In the real
              IELTS exam, the recording is played <strong>ONLY ONCE</strong>.
              For practice, you may pause and replay. Try to listen straight
              through for the best preparation.
            </p>
          </div>
        </div>
            ...
            <div className="sticky top-24 space-y-5">
              ...
              <div className="bg-white rounded-2xl shadow-md border border-gray-200/80 p-5">
                <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm uppercase tracking-wider">
                  <span className="w-6 h-6 rounded-md bg-primary text-white flex items-center justify-center text-xs">
                    i
                  </span>
                  Test Rules
                </h3>
                <ul className="space-y-3 text-sm text-gray-600">
                  {[
                    {
                      bold: "No repeats:",
                      text: "In the real exam the audio plays only once.",
                    },
                    {
                      bold: "Spelling matters:",
                      text: "Incorrect spelling costs marks.",
                    },
                    {
                      bold: "Word limits:",
                      text: "Follow word-count instructions carefully.",
                    },
                    {
                      bold: "Transfer time:",
                      text: "You get 10 min to transfer answers on the real test.",
                    },
                  ].map((r, i) => (
